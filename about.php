...
<html lang="en">
  <head>
    ...
    <title>RR Screens | About us Page</title>
        ...
        <div class="container">
            ...
            <div class="cwp4-image col-xl-6">
                ...
                <div class="cwp4-text col-xl-6 ">
                    ...
                    <h3 class="">What We Stand For</h3>
                    <div class="hair-two-colums">
                        <div class="hair-left">
<h5>
Protection Without Compromise</h5>
</div>
                        <div class="hair-left">
                            <h5>Custom-Fit Solutions</h5>
                        </div>
                            <div class="hair-left">
                                                        <h5>Eco-Conscious Living</h5>
   ...
   <div class="hair-left">
                                                                                   ...
                                                                                   <div class="hair-left">
                                                                                    <h5>Offering a chemical-free, environmentally safe alternative</h5>
                                                                                </div>

                                                                                   <div class="hair-left">
                                                                                    <h5>Building trust through responsive service</h5>
                                                                                </div>
